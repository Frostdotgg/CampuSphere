...
canonical authority file and the synchronized 2026-09-09 block below. Current
pushed source ends at `7b4e818`; its exact Vercel deployment is independently
verified Ready/Production/Current and its bounded Production smoke passed
`127/127`. Older detailed records in this handoff are historical and must not
override the canonical snapshot.
