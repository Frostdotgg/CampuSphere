...
/* ========================================
   ...
   Offline-scope boundary (2D-only correction):
     - EXACT SHELL ALLOWLIST. The only same-origin requests eligible for Cache
       ...
       extension-wide or directory-wide rule, so '/css/styles.css?v=12' is
       cacheable while an unreviewed '/css/styles.css?v=13' is not.
...
var PRECACHE_URLS = [
  ...
  '/img/icons/campussphere-favicon-48.png',
  '/img/icons/campussphere-192.png',
  '/img/icons/campussphere-512.png',
  '/img/icons/campussphere-maskable-192.png',
  '/img/icons/campussphere-maskable-512.png',
  '/img/icons/campussphere-apple-180.png'
];
