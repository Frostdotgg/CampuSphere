...
0020; the read-only sync preview; the Android compatibility observation; missing
promotion, Production acceptance, and deployed-byte proof for the current
product; and the external Final Milestone 12 disposition.
