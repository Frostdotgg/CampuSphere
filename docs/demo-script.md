...
## Current route/media demonstration note (2026-09-09)
...
equality. The post-promotion smoke did not send an authenticated Production
heartbeat. This script does not authorize a live-data demonstration.
