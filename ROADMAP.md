...
The owner-promoted `13adb9d` release adds recoverable fail-closed session
...
offline guest UAT was not rerun. The next product milestone is chosen by the
owner from bug fixes or add/change/remove features. Current MySQL parity and
