...
canonical authority file and the synchronized September 22 block below. At the
start of this checkpoint, local, upstream, and remote `main` matched product
commit `0e7fe8b`; the owner-observed Vercel Production deployment is
`dpl_HbJRojVKtJUeUr2KMY6XhcRv6RCS`. Retained LT-01 through LT-06 passed,
